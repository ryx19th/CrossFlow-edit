...
class T5Embedder:
    ...
    def __init__(self, device, dir_or_name='t5-v1_1-xxl', *, cache_dir=None, hf_token=None, use_text_preprocessing=True,
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(f'DeepFloyd/{dir_or_name}')
        self.model = T5EncoderModel.from_pretrained(f'DeepFloyd/{dir_or_name}', **t5_model_kwargs).eval()
        print('[t5 loaded]')
