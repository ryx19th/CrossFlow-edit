...
def get_config():
    ...
    config.optimizer = d(
        name='adamw',
        lr=0.0001, # 0.000001, # 0.00001, #                                      # learning rate
        weight_decay=0, # 0.03, # 
        betas=(0.9, 0.9),
    )
    ...
    config.lr_scheduler = d(
        name='customized',
        warmup_steps=1000, # 5000, #                                 # warmup steps
    )
