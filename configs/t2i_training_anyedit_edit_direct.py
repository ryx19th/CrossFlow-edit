...
model = Args(
    ...
    edit_mode=True,
    cond_mode='channel', # 'cross-attn', # 'self-attn', #              # ['channel', 'cross-attn', 'self-attn'] 
    direct_map=True,
)
...
def get_config():
    ...
    config.workdir = 't2i_training_anyedit_edit_direct_dup' # 't2i_training_anyedit_edit_direct' # 
