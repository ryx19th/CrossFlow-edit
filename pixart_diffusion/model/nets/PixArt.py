...
from pixart_diffusion.model.builder import MODELS
from pixart_diffusion.model.utils import auto_grad_checkpoint, to_2tuple
from pixart_diffusion.model.nets.PixArt_blocks import t2i_modulate, CaptionEmbedder, AttentionKVCompress, MultiHeadCrossAttention, T2IFinalLayer, TimestepEmbedder, LabelEmbedder, FinalLayer
from pixart_diffusion.utils.logger import get_root_logger
...
class PixArt(nn.Module):
    ...
    def _forward(self, x, timestep, y, mask=None, data_info=None, cond_image=None, **kwargs):
        """
    ...
    # def _forward_wrapper(self, x, t, null_indicator, cond_image=None, cond_mask=None):
    #     return self._forward(x, t, cond_image, mask=cond_mask)

    # def _forward_with_dpmsolver(self, x, timestep, y, mask=None, cond_image=None, **kwargs):
    #     """
    ...
    def _forward_with_cfg(self, x, timestep, y, cfg_scale, mask=None, cond_image=None, **kwargs):
        """
        ...
        model_out = self._forward(combined, timestep, y, mask=mask, cond_image=cond_image, **kwargs)
    ...
    def forward(self, x, t = None, log_snr = None, text_encoder=False, text_decoder=False, image_clip=False, shape=None, mask=None, null_indicator=None, cond_image=None, cond_mask=None, cfg_scale=0.0):
        if cfg_scale > 0.0:
            return self._forward_with_cfg(x, t, cond_image, cfg_scale, mask=cond_mask)
        else:
            return self._forward(x, t, cond_image, mask=cond_mask)
